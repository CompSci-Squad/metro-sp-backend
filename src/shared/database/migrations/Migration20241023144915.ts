...
export class Migration20241023144915 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table "entrance" add column "station_id" int not null, add column "terminal_id" int null;`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "entrance" drop constraint "entrance_terminal_id_unique";`);
    this.addSql(`alter table "entrance" drop column "station_id", drop column "terminal_id";`);
  }
